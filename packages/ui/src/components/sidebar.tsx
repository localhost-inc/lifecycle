...
const sidebarMenuButtonVariants = cva(
  "flex w-full cursor-pointer items-center gap-2 overflow-hidden rounded-lg px-2 py-1.5 text-left text-sm font-medium outline-none transition-colors focus-visible:ring-1 focus-visible:ring-[var(--ring)] disabled:cursor-not-allowed disabled:pointer-events-none disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      active: {
        false:
...
function SidebarMenuAction({
  ...
  return (
    <ButtonPrimitive
      className={cn(
        "absolute right-1 top-1/2 z-10 flex size-5 -translate-y-1/2 cursor-pointer items-center justify-center rounded text-[var(--sidebar-muted-foreground)] outline-none transition-colors focus-visible:ring-1 focus-visible:ring-[var(--ring)] hover:bg-[var(--sidebar-hover)] hover:text-[var(--sidebar-foreground)] disabled:cursor-not-allowed disabled:pointer-events-none disabled:opacity-50",
        showOnHover &&
...
const sidebarMenuSubButtonVariants = cva(
  "flex w-full cursor-pointer items-center gap-2 overflow-hidden rounded-lg px-2 py-1.5 text-left text-sm outline-none transition-colors focus-visible:ring-1 focus-visible:ring-[var(--ring)] disabled:cursor-not-allowed disabled:pointer-events-none disabled:opacity-50 [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0",
  {
    variants: {
      active: {
        false:
