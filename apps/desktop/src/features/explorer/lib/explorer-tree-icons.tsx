...
export type ExplorerTreeIconName =
  | "archive"
  | "code"
  | "config"
  | "data"
...
interface ExplorerTreeIconDefinition {
  Icon: LucideIcon;
  name: ExplorerTreeIconName;
}

const GENERIC_FILE_ICON: ExplorerTreeIconDefinition = {
  Icon: FileText,
  name: "generic",
};
...
function iconDefinition(name: ExplorerTreeIconName, Icon: LucideIcon): ExplorerTreeIconDefinition {
  return { Icon, name };
}

export function resolveExplorerTreeIcon(
  filePath: string,
  extension: string | null,
): ExplorerTreeIconDefinition {
