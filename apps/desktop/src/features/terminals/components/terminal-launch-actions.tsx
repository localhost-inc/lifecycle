import { Button, Tooltip, TooltipContent, TooltipProvider, TooltipTrigger } from "@lifecycle/ui";
import type { ReactNode } from "react";
import type { CreateTerminalRequest, HarnessProvider } from "../api";

interface TerminalLaunchActionsProps {
...
export function TerminalLaunchActions({
  creatingSelection,
  onCreateTerminal,
}: TerminalLaunchActionsProps) {
  const disabled = creatingSelection !== null;
