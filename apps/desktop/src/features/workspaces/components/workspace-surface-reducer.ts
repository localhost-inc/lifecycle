...
import {
  ...
  type WorkspaceSurfaceTabStateByKey,
...
export type WorkspaceSurfaceAction =
  ...
  | { key: string; kind: "set-tab-view-state"; viewState: WorkspaceSurfaceTabViewState | null }
  | {
...
function removeHiddenRuntimeTabsFromPaneState(
  paneTabStateById: WorkspaceSurfaceState["paneTabStateById"],
  hiddenRuntimeTabKeySet: ReadonlySet<string>,
): WorkspaceSurfaceState["paneTabStateById"] {
