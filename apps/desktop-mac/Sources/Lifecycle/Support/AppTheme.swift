...
struct AppThemeBackgroundTokens {
  let chrome: Color
  let panel: Color
  let surface: Color
...
struct AppThemeForegroundTokens {
  let primary: Color
  let muted: Color
  let accent: Color
...
struct AppTheme: Equatable, Sendable {
  ...
  private let foregroundHex: String
  let card: String
  let surface: String
  ...
  init(
    ...
    terminalSurfaceBackground: String,
    ...
    self.sidebarMutedForeground = sidebarMutedForeground
    self.sidebarHover = sidebarHover
    self.sidebarSelected = sidebarSelected
    self.terminalSurfaceBackground = terminalSurfaceBackground
    ...
    self.terminalAnsiBlack = terminalAnsiBlack
    self.terminalAnsiRed = terminalAnsiRed
    self.terminalAnsiGreen = terminalAnsiGreen
    self.terminalAnsiYellow = terminalAnsiYellow
    self.terminalAnsiBlue = terminalAnsiBlue
    self.terminalAnsiMagenta = terminalAnsiMagenta
    self.terminalAnsiCyan = terminalAnsiCyan
    self.terminalAnsiWhite = terminalAnsiWhite
    self.terminalAnsiBrightBlack = terminalAnsiBrightBlack
    self.terminalAnsiBrightRed = terminalAnsiBrightRed
    self.terminalAnsiBrightGreen = terminalAnsiBrightGreen
    self.terminalAnsiBrightYellow = terminalAnsiBrightYellow
    self.terminalAnsiBrightBlue = terminalAnsiBrightBlue
    self.terminalAnsiBrightMagenta = terminalAnsiBrightMagenta
    self.terminalAnsiBrightCyan = terminalAnsiBrightCyan
    self.terminalAnsiBrightWhite = terminalAnsiBrightWhite
    ...
    self.gitStatusAdded = gitStatusAdded
    self.gitStatusModified = gitStatusModified
    self.gitStatusDeleted = gitStatusDeleted
    self.gitStatusRenamed = gitStatusRenamed
  }

  var background: AppThemeBackgroundTokens {
    AppThemeBackgroundTokens(
      chrome: color(backgroundHex),
      panel: color(card),
      surface: color(surface),
      surfaceRaised: color(surfaceHover),
      surfaceSelected: color(surfaceSelected),
      overlay: color(glass),
      overlayHover: color(glassHover),
      chromeHex: backgroundHex,
      panelHex: card,
      surfaceHex: surface
    )
  }

  var foreground: AppThemeForegroundTokens {
    AppThemeForegroundTokens(
      primary: color(foregroundHex),
      muted: color(mutedForeground),
      accent: color(accent),
      primaryHex: foregroundHex,
      mutedHex: mutedForeground,
      accentHex: accent
    )
  }

  var shellBackground: Color { background.chrome }
  ...
  var panelBackground: Color { background.panel }
  var chromeBackground: Color { background.overlay }
  var surfaceBackground: Color { background.surface }
  var surfaceRaised: Color { background.surfaceRaised }
  var primaryTextColor: Color { foreground.primary }
  var primaryColor: Color { color(primary) }
  var primaryForegroundColor: Color { color(primaryForeground) }
  var mutedColor: Color { foreground.muted }
  ...
  var accentColor: Color { foreground.accent }
