...
struct BridgeWorkspaceTerminalsEnvelope: Decodable {
  ...
  init(workspace: BridgeWorkspaceScope, runtime: BridgeTerminalRuntime, terminals: [BridgeTerminalRecord]) {
  ...
  init(from decoder: Decoder) throws {
    ...
    self.workspace = try container.decode(BridgeWorkspaceScope.self, forKey: .workspace)
    self.runtime = try container.decodeIfPresent(BridgeTerminalRuntime.self, forKey: .runtime)
      ?? BridgeTerminalRuntime.unavailable("Terminal runtime was missing from bridge response.")
    self.terminals = try container.decodeIfPresent([BridgeTerminalRecord].self, forKey: .terminals) ?? []
  }
...
struct BridgeAppearanceSettings: Decodable, Equatable {
  let theme: String
  let fonts: BridgeAppearanceFontSettings?
  let dimInactivePanes: Bool?
  let inactivePaneOpacity: Double?
}

struct BridgeAppearanceFontSettings: Decodable, Equatable {
  let ui: String?
  let code: String?
}
...
struct BridgeTerminalRuntime: Decodable, Hashable {
  ...
  init(from decoder: Decoder) throws {
    let container = try decoder.container(keyedBy: CodingKeys.self)
    self.init(
      backendLabel: try container.decodeIfPresent(String.self, forKey: .backendLabel) ?? "unavailable",
      ...
      supportsCreate: try container.decodeIfPresent(Bool.self, forKey: .supportsCreate) ?? false,
      supportsClose: try container.decodeIfPresent(Bool.self, forKey: .supportsClose) ?? false,
      supportsConnect: try container.decodeIfPresent(Bool.self, forKey: .supportsConnect) ?? false,
      supportsRename: try container.decodeIfPresent(Bool.self, forKey: .supportsRename) ?? false
    )
  }

  static func unavailable(_ message: String) -> BridgeTerminalRuntime {
    BridgeTerminalRuntime(
...
struct BridgeTerminalRecord: Decodable, Hashable, Identifiable {
  ...
  let kind: String
  let busy: Bool
  let activity: BridgeTerminalActivityRecord?
  ...
  init(
    ...
    kind: String,
    busy: Bool,
    activity: BridgeTerminalActivityRecord? = nil
  ) {
  ...
  init(from decoder: Decoder) throws {
    ...
    self.init(
      ...
      kind: try container.decodeIfPresent(String.self, forKey: .kind) ?? BridgeTerminalKind.shell.rawValue,
      busy: try container.decodeIfPresent(Bool.self, forKey: .busy) ?? false,
      activity: try container.decodeIfPresent(BridgeTerminalActivityRecord.self, forKey: .activity)
    )
  }
...
struct BridgeWorkspaceActivitySummary: Decodable, Hashable {
  let workspaceID: String
  let busy: Bool
...
struct BridgeTerminalActivityRecord: Decodable, Hashable {
