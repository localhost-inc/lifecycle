# Shell / Workbench Doc Split - 2026-03-14
...
2. `reference/workspace-workbench.md`
...
1. The shell contract can stay stable even while the workbench implementation evolves.
2. The workbench contract can change at the pane-behavior level without forcing shell IA rewrites.
...
2. It reduces drift risk as project/org shell work and workspace runtime/workbench work proceed on different clocks.
...
3. When the workbench cutover is complete, retire or demote the older `workspace-surface.md` contract explicitly.
