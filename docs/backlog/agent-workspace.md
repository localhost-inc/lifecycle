...
4. Local native runtime and compatibility adapters must both emit the same conceptual `agent.*` fact families, following the runtime event foundation contract:
