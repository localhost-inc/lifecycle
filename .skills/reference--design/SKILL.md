...
description: Design language and animation specs for building or reviewing UI components
user-invocable: true
---

Apply the following design language and animation specs as context for the current task. All UI work should conform to these component rules and motion guidelines.
