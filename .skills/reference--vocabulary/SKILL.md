---
name: reference--vocabulary
description: Canonical product terminology for naming, code review, or doc writing
user-invocable: true
---

Apply the following canonical vocabulary as context for the current task. Enforce consistent terminology across code, APIs, UI copy, and documentation. Flag deviations and suggest corrections.
