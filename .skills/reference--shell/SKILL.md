...
description: App shell v2 layout contract for desktop shell and navigation work
user-invocable: true
---

Apply the following app shell contract as context for the current task. All desktop shell layout, navigation controls, sidebar behavior, and panel structure should conform to these rules.
