...
description: Brand guidelines — voice, color, typography, tone — for copy or visual identity work
user-invocable: true
---

Apply the following brand guidelines as context for the current task. All user-facing text, styling, and visual identity decisions should conform to these rules.
