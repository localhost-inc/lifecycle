...
description: Test job orchestration spec for test infrastructure work (deferred Phase 3)
user-invocable: true
---

Apply the following test job orchestration spec as context for the current task.
